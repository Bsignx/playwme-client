...
export async function getStaticProps() {
  const descriptionHTML = `
    ...
    * Exclusive Digital Comic - Cyberpunk 2077: Big City Dreams will be available in English only.
    ...
    Take the riskiest job of your life and go after a prototype implant that is the key to imortality.
  ...
  return {
    props: {
      ...
      gameInfo: {
        ...
        price: '59.00',
        description:
          'Cyberpunk 2077 is an open-world, action-adventure story set in Night City, a megalopolis obsessed with power, glamour and body modification. You play as V, a mercenary outlaw going after a one-of-a-kind implant that is the key to imortality'
      },
      gallery: galleryMock,
